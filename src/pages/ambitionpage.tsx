    ...
    <main className="font-poppins">
      ...
      <section className="grid grid-cols-2 mx-16 mt-32 gap-28 mobile:grid-cols-1 tabletportrait:grid-cols-1 tabletlandscape:grid-cols-1">
        <div className="flex flex-col">
          ...
          <select className="text-3xl font-xxbold text-purple -ml-1 w-fit underline underline-offset-2 decoration-lightxPurple pr-0">
      ...
      <section className="mx-16 mb-16">
        ...
        <div className="grid grid-cols-3 grid-rows-2 gap-6 text-md">
          <div className="bg-lightPink skew-x-12 max-w-sm">
            <p className="px-6 py-2 line-clamp-2 text-purple -skew-x-12"><b className="text-2xl text-purple">€1</b> die men investeert in fiets-infrastructuur leidt tot <b className="text-2xl text-purple">€14 return</b></p>
          </div>
          <div className="bg-lightPink skew-x-12 max-w-sm">
          ...
          <div className="bg-lightPink skew-x-12 max-w-lg">
              <p className="px-6 py-2 line-clamp-2 text-purple -skew-x-12">Fietsers en voetgangers zijn tot <b className="text-2xl text-purple">30% meer</b> geneigd om <b className="text-2xl text-purple">lokaal te kopen</b> dan automobilisten</p>
          </div>
          <div className="bg-lightPink skew-x-12 max-w-md">
      ...
      <section className="px-16 pb-16 bg-neutral">
        ...
        <div className="grid grid-cols-4 gap-10 tabletlandscape:grid-cols-2 mobile:grid-cols-1">
      ...
      <section className="px-16 pb-16" id="Practises">
        ...
        <div className="grid grid-cols-2 gap-8 mobile:grid-cols-1">
          <div>
            ...
            <div className="flex items-center text-sm relative bottom-3 left-3 tabletlandscape:text-xs">

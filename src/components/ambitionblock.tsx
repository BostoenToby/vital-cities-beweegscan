...
export default ({ header, text, shorttext }: { header: string; text: string, shorttext: string }) => {
  ...
  const getIcon = (number: string) =>{
    if(number == "1") {
      return(
        <div className="flex items-center justify-center mx-auto mb-4 h-16 w-16 rounded-full bg-lightxPurple opacity-50">
          <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 20 20" height="48px" viewBox="0 0 20 20" width="48px" fill="#492784">
            <g>

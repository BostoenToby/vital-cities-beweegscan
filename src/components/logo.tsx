...
export default (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      ...
      <style>
        {'.n{fill:#fff}.p{fill:#f2c123}.r{fill:none}.t{fill:url(#k)}'}
      </style>
    </defs>
    <path
      id="b"
    ...
    <g id="e">
      <path id="f" className="n" d="M60 31.16 88 31 72.99 63 60 31.16z" />
      <path id="g" className="n" d="M92.5 31h8v32h-8z" />
      <path id="h" className="n" d="M104.5 31.5h24v8h-24z" />
      <path
        id="i"
        className="n"
        d="m153.91 62.69-28 .16 15.01-32 12.99 31.84z"
      />
      <path id="j" className="n" d="M156 30.52h8v32h-8z" />
      <path id="l" className="t" d="M112 39h9v24h-9z" />
      <path id="m" className="t" d="M163.5 62.5V53H181v9.5h-17.5z" />
    </g>
  </svg>
)
